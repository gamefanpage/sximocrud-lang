...
<div class="sbox">
	...
	<div class="text-center">
		...
		<div class="form-group has-feedback">
			<label> {{ Lang::get('core.fr_remindnew'); }} </label>
			{{ Form::password('password',  array('class'=>'form-control', 'placeholder'=>'New Password')) }}
			<i class="icon-lock form-control-feedback"></i>
		</div>
		
		  <div class="form-group has-feedback">
			<label> {{ Lang::get('core.fr_remindnewagain'); }} </label>
      ...
      <div class="form-group has-feedback">
      		<label></label>
			<div class="col-xs-6">
			  <button type="submit" class="btn btn-primary pull-right"> {{ Lang::get('core.fr_remindreset'); }} </button>
			</div>
      </div>
